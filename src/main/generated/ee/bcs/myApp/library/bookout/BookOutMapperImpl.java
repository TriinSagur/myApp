...
public class BookOutMapperImpl implements BookOutMapper {
    ...
    public BookOutDto toDto(BookOut bookOut) {
        ...
        bookOutDto.setBookId( bookOutBookId( bookOut ) );
        bookOutDto.setBookTitle( bookOutBookTitle( bookOut ) );
        bookOutDto.setBookYear( bookOutBookYear( bookOut ) );
        bookOutDto.setId( bookOut.getId() );
        bookOutDto.setIsReturned( bookOut.getIsReturned() );
