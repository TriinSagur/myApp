...
public class ValidationService {
    ...
    public static final String DEPOSIT_OVER_LIMIT = "Deposiidi liimit on ületatud";
    ...
    public void isWithinBalance(Integer balance, Integer amount) {
        if (amount > balance) {
            throw new BusinessException(INSUFFICIENT_FUNDS, "Summa " + amount + "ületab konto jääki €" + balance);
        }
    }
}