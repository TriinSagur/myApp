...
import ee.bcs.myApp.bank.domain.account.service.DepositRequest;
import ee.bcs.myApp.bank.domain.account.service.MoneyRequest;
import ee.bcs.myApp.bank.domain.account.service.WithdrawRequest;
