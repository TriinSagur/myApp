...
public class TransactionService {
    ...
    public Transaction addSendMoneyTransaction(MoneyRequest request) {
        ...
        Integer senderBalance = senderAccount.getBalance(); // teeme loetavuse paremaks, ülejärgmise rea vaates
        Integer amount = request.getAmount();  // teeme loetavuse paremaks, kohalik muutuja ja siis 5 muudatust korraga sarnastele asjadele
